...
public class WeixiudingdanView extends WeixiudingdanEntity implements Serializable {
	...
	* 维修类型的值
	*/
	@ColumnInfo(comment="维修类型的字典表值",type="varchar(200)")
	private String weixiuyuyueValue;
	/**
	* 维修状态的值
	*/
	@ColumnInfo(comment="维修状态的字典表值",type="varchar(200)")
	private String weixiudingdanValue;
	...
	* 获取： 维修状态的值
	*/
	public String getWeixiudingdanValue() {
		return weixiudingdanValue;
	}
	/**
	* 设置： 维修状态的值
	*/
	public void setWeixiudingdanValue(String weixiudingdanValue) {
		this.weixiudingdanValue = weixiudingdanValue;
	}
	...
	public String toString() {
		return "WeixiudingdanView{" +
			", weixiuyuyueValue=" + weixiuyuyueValue +
			", weixiudingdanValue=" + weixiudingdanValue +
