  ...
  <div>
    ...
    >  
     <el-row>
         ...
         <el-col :span="12">
             <el-form-item v-if="flag=='weixiuyuan'" label='维修员头像' prop="weixiuyuanPhoto">
                 <file-upload
                         tip="点击上传照片"
                         action="file/upload"
                         :limit="3"
         ...
         <el-col :span="12">
           <el-form-item v-if="flag=='weixiuyuan'"  label='维修员邮箱' prop="weixiuyuanEmail">
               <el-input v-model="ruleForm.weixiuyuanEmail"  placeholder='维修员邮箱' clearable></el-input>
           </el-form-item>
         </el-col>
