               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="维修员邮箱" prop="weixiuyuanEmail">
                       <el-input v-model="ruleForm.weixiuyuanEmail"
                                 placeholder="维修员邮箱" clearable  :readonly="ro.weixiuyuanEmail"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
        ...
        data() {
            return {
                ...
                rules: {
                   ...
                   weixiuyuanPhoto: [
                              { required: true, message: '维修员头像不能为空', trigger: 'blur' },
                          ],
                   sexTypes: [
                   ...
                   weixiuyuanEmail: [
                              { required: true, message: '维修员邮箱不能为空', trigger: 'blur' },
                              { pattern: /^([a-zA-Z0-9_-])+@([a-zA-Z0-9_-])+(.[a-zA-Z0-9_-])+/,
                                message: '维修员邮箱只能是邮箱格式',
                                trigger: 'blur'
                              }
                          ],
                }
