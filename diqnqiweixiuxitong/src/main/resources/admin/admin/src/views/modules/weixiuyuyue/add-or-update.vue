    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="weixiuyuanId" name="weixiuyuanId" type="hidden">
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="物品名称" prop="weixiuyuyueName">
                       <el-input v-model="ruleForm.weixiuyuyueName"
                                 placeholder="物品名称" clearable  :readonly="ro.weixiuyuyueName"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="物品名称" prop="weixiuyuyueName">
                           <el-input v-model="ruleForm.weixiuyuyueName"
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="预约编号" prop="weixiuyuyueUuidNumber">
                       <el-input v-model="ruleForm.weixiuyuyueUuidNumber"
                                 placeholder="预约编号" clearable  :readonly="ro.weixiuyuyueUuidNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="预约编号" prop="weixiuyuyueUuidNumber">
                           <el-input v-model="ruleForm.weixiuyuyueUuidNumber"
                ...
                <el-col :span="12">
                    <el-form-item class="upload" v-if="type!='info' && !ro.weixiuyuyuePhoto" label="物品照片" prop="weixiuyuyuePhoto">
                        <file-upload
                            tip="点击上传物品照片"
                            action="file/upload"
                            :limit="3"
                            :multiple="true"
                            :fileUrls="ruleForm.weixiuyuyuePhoto?$base.url+ruleForm.weixiuyuyuePhoto:''"
                            @change="weixiuyuyuePhotoUploadChange"
                        ></file-upload>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.weixiuyuyuePhoto" label="物品照片" prop="weixiuyuyuePhoto">
                            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in (ruleForm.weixiuyuyuePhoto || '').split(',')" :src="$base.url+item" width="100" height="100">
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="物品维修类型" prop="weixiuyuyueTypes">
                        <el-select v-model="ruleForm.weixiuyuyueTypes" :disabled="ro.weixiuyuyueTypes" placeholder="请选择物品维修类型">
                            <el-option
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="物品维修类型" prop="weixiuyuyueValue">
                        <el-input v-model="ruleForm.weixiuyuyueValue"
                            placeholder="物品维修类型" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12">
                    <el-form-item v-if="type!='info'"  class="input" label="预约维修时间" prop="yuyueTime">
                        <el-date-picker
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.yuyueTime" label="预约维修时间" prop="yuyueTime">
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="物品损坏详情" prop="weixiuyuyueContent">
                        <editor style="min-width: 200px; max-width: 600px;"
                                v-model="ruleForm.weixiuyuyueContent"
                                class="editor"
                                action="file/upload">
                        </editor>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.weixiuyuyueContent" label="物品损坏详情" prop="weixiuyuyueContent">
                            <span v-html="ruleForm.weixiuyuyueContent"></span>
                        </el-form-item>
                    </div>
                </el-col>
            <el-col :span="12" v-if="type=='info'">
                <div>
                    <el-form-item v-if="ruleForm.weixiuyuyueYesnoTypes" label="预约状态" prop="weixiuyuyueYesnoTypes">
                        <el-input v-model="ruleForm.weixiuyuyueYesnoValue" placeholder="预约状态" readonly></el-input>
                    </el-form-item>
                </div>
            </el-col>
            <el-col :span="12" v-if="type=='info'">
                <div>
                    <el-form-item v-if="ruleForm.weixiuyuyueYesnoText" label="审核意见" prop="weixiuyuyueYesnoText">
                        <span v-html="ruleForm.weixiuyuyueYesnoText"></span>
                    </el-form-item>
                </div>
            </el-col>
            <el-col :span="12" v-if="type=='info'">
                <div>
                    <el-form-item v-if="ruleForm.weixiuyuyueShenheTime" label="审核时间" prop="weixiuyuyueShenheTime">
                        <span v-html="ruleForm.weixiuyuyueShenheTime"></span>
                    </el-form-item>
                </div>
            </el-col>
            </el-row>
    ...
    export default {
        data() {
            return {
                ...
                ruleForm: {
                    ...
                    weixiuyuanId: '',
                    weixiuyuyueName: '',
                    weixiuyuyueUuidNumber: new Date().getTime(),
                    weixiuyuyuePhoto: '',
                    weixiuyuyueTypes: '',
                    yuyueTime: '',
                    weixiuyuyueContent: '',
                    insertTime: '',
                    weixiuyuyueYesnoTypes: '',
                ...
                rules: {
                   ...
                   weixiuyuyueTypes: [
                              { required: true, message: '物品维修类型不能为空', trigger: 'blur' },
                              {  pattern: /^[0-9]*$/,
                                  message: '只允许输入整数',
                                  trigger: 'blur'
                              }
                   ...
                   yuyueTime: [
                              { required: true, message: '预约维修时间不能为空', trigger: 'blur' },
                          ],
                   weixiuyuyueContent: [
                              { required: true, message: '物品损坏详情不能为空', trigger: 'blur' },
                          ],
                   insertTime: [
        ...
        created() {
            ...
            //获取下拉框信息
                ...
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=weixiuyuyue_yesno_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.weixiuyuyueYesnoTypesOptions = data.data.list;
                    }
                });
        ...
        methods: {
            ...
            info(id) {
                ...
                _this.$http({
                    ...
                    if (data && data.code === 0) {
                        ...
                        _this.ruleForm.weixiuyuyueContent = _this.ruleForm.weixiuyuyueContent.replaceAll("src=\"upload/","src=\""+this.$base.url+"upload/");
                    } else {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.ruleForm.weixiuyuyueContent = this.ruleForm.weixiuyuyueContent.replaceAll(this.$base.url,"");
                        this.$http({
            ...
            //图片
            weixiuyuyuePhotoUploadChange(fileUrls){
                this.ruleForm.weixiuyuyuePhoto = fileUrls;
                this.addEditUploadStyleChange()
            },
