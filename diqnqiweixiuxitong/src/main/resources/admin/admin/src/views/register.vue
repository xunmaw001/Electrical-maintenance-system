    ...
    <div>
        <div class="container">
            <div class="login-form">
                <h1 class="h1" style="color:#000;fontSize:28px;">电器维修系统注册</h1>
                <el-form class="rgs-form">
                    ...
                    <el-form-item label="重复密码" class="input">
                        ...
                        <!--
                            ...
                            <el-form-item label="维修员头像" class="input" v-if="tableName=='weixiuyuan'">
                                    <file-upload
                                        tip="点击上传维修员头像"
                                        action="file/upload"
                                        :limit="1"
                        ...
                        -->
                        <el-form-item label="维修员邮箱" class="input" v-if="tableName=='weixiuyuan'">
                            <el-input v-model="ruleForm.weixiuyuanEmail" autocomplete="off" placeholder="维修员邮箱"  />
                        </el-form-item>
                        <!--
                            <el-form-item label="创建时间" class="input" v-if="tableName=='weixiuyuan'">
...
.container {
    ...
    background-repeat: no-repeat;
        background-image: url(/diqnqiweixiuxitong/img/back-img-bg.jpg);
